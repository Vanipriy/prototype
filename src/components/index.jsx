            ...
            <div className="relative">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto text-center px-6">
                        <img
                            src="src/assets/Prototype13.png"
            ...
            <div className="font-sans">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-6 py-8">
                    <div className="text-center">
                        <img src="src/assets/Prototype6.png" alt="Shop New Arrivals" className="w-[286px] h-[300px] object-cover mx-auto" />
                        <p className="mt-2 text-sm font-medium uppercase">SHOP NEW ARRIVALS</p>
                    </div>
                    <div className="text-center">
                        <img src="src/assets/Prototype7.png" alt="Shop Men's" className="w-[286px] h-[300px] object-cover mx-auto" />
                        <p className="mt-2 text-sm font-medium uppercase">SHOP MEN'S</p>
                    </div>
                    <div className="text-center">
                        <img src="src/assets/Prototype8.png" alt="Shop Women's" className="w-[286px] h-[300px] object-cover mx-auto" />
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                        <div className="md:w-3/5 text-center">
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-6">
                                <img src="src/assets/Prototype9.png" alt="Prototype9" className="w-32 h-32 object-cover" />
                                <img src="src/assets/Prototype10.png" alt="Prototype10" className="w-32 h-32 object-cover" />
                                <img src="src/assets/Prototype11.png" alt="Prototype11" className="w-32 h-32 object-cover" />
                                <img src="src/assets/Prototype12.png" alt="Prototype12" className="w-32 h-32 object-cover" />
                            </div>
                        </div>
                        <div className="md:w-2/5 bg-white p-6 shadow-lg">
                            ...
                            <div className="flex justify-end mt-4">
                                <img src="src/assets/Prototype14.png" alt="Payment Options" className="w-56" />
                            </div>
                        </div>
                    </div>
                </div>
